...
{
    public partial class ProduktionAnzeigeControl : UserControl
    {
        private UniDExContext _context;

        public ProduktionAnzeigeControl()
        {
            InitializeComponent();
        }
        ...
        private void ladeProduktion()
        {
            ...
            // Datenquellen setzen
            materialBedarfContainerBindingSource.DataSource = _context.MaterialBedarf.OrderByDescending(e => e.BelegJahr).ThenByDescending(e => e.BelegNummer)
                .ThenBy(e => e.BelegPositionsNummer).ToList();*/
        }
